...
from auth_database import create_user, authenticate_user, get_all_users, update_user, get_user_by_id
...
async def change_password(
    ...
    try:
        from auth_database import verify_password, get_password_hash
